...
- `dataset/olist_customers.csv`: csv with info regarding the location of the customers.
- `dataset/olist_order_items.csv`: csv with info regarding the shipping.
- `dataset/olist_order_payments.csv`: csv with info regarding the payment.
- `dataset/olist_order_reviews.csv`: csv with info regarding the clients' reviews.
- `dataset/olist_orders.csv`: csv with info regarding the different dates of each sale's process.
- `dataset/olist_products.csv`: csv with info regarding the details of each product.
- `dataset/olist_sellers.csv`: csv with info regarding the location of the sellers.
